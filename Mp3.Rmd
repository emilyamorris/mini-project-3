...
ggplot(Spring_sap, aes(x=Month, y= total_days, color= Year))+
  ...
  xlab("Month")+
  ylab("Total Number of Days on Which Sap was Collected (by year)")+
  theme_economist()+
  labs(title= "Sap Collection Days versus Months of Spring", subtitle= "With changes by year")
...
```{r warning= FALSE, message= FALSE, fig.show= "hold", fig.width=20, fig.height= 7}
