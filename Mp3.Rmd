...
Plot_months <- function(name_arg){
  calendarPlot(weather_and_all_possible_days, pollutant= "temp_total", year= name_arg, breaks= c(0, 1, 2), labels= c("Incorrect Temperature Ranges", "Correct Temperature Ranges"), cols= c("#d5f2f0", "#45e05f"))
}

list_of_years <- list(2012, 2013, 2014, 2015, 2016, 2017)

all_year_plot <- lapply(list_of_years, Plot_months)
