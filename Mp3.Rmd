...
#Introduction
Sugar maple trees, *Acer saccharum*, are a vital part of the economic and ecological systems of Massachusetts and the northeastern United States. Maple sap is collected and boiled down into syrup to create a valuable commodity for the state. 

Maple sap production requires a delicate balance of weather conditions that are only achieved during “sugaring season”, or the spring season in temperate areas. Specifically, the temperature fluctuations must be such that the temperature is above freezing (32 degrees fahrenheit) during the day, and below freezing at night. 

Global climate change stands to have a significant impact on maple tree function and distribution within the coming years. Tree availability and health as well as timing and length of the tapping season are among the most vulnerable factors in the sugaring industry. Fluctuations in climatic temperature and other conditions could lead to altered suitability of habitat and reductions in maple distribution in most of the United States by 2100. 
...
ALthough it may not be known to some students, Smith collects maple sap at the MacLeish Field Station, which the college owns, that is around 20 minutes away from main campus. MacLeish is 240 acres of land, located in West Whately, Massachusetts. Areas of maple trees where you collect sap are called "sugar bushes," and Reid Bertone-Johnson, manager of MacLeish, says that they collect sap from the sugar bush closer to the center of MacLeish, near the observatory and "bunker,"
...
#Sap Season Trends
Pictured below is the total number of days on which sap could be collected plotted against typical sugaring season months. It can be seen that the number of possible collection days increases in more recent years in months that previously would have been too cold to tap in, primarily January and February. Since tapping requires temperatures above freezing during the day, this graph--along with other factors--is indicative of a warming climate. 
...
!([http://assets.climatecentral.org/images/made/2017MapleSyrup_Map_en_title_lg_660_371_s_c1_c_c.jpg]

!()[http://assets.climatecentral.org/images/made/2017MapleSyrup_FreezeThawExplainer_part2_en_title_lg_660_371_s_c1_c_c.jpg]
...
#PLOTTIN MORE TRENDS YA'LL BUT THIS TIME WITH CALENDARS AND REAL SAP
...
#SHOULD PROBABLY PUT SOME CONCLUSIONS RIGHT HERE

#SUGGESTIONS FOR THE MACLEISH PEEPS
...
Additionally, what some other maple sap-producing farms have done in Massachusetts is implementing some cautious practices in response to climate change in order to produce the greatest amount of sap in a shorter season. This measures include sustainable forest management, better sanitation practices of maple taps, and using a vacuum system to maximize maple collection. There is also the possibility that if the correct temperatures could no longer be reached in the spring season, some tapping could occur in the fall if the conditions were right. 
...
!()[http://thumbpress.com/wp-content/uploads/2016/02/cool-wine-bottle-Canada-maple-syrup.jpg]
