...
Plot_months<- function(name_arg){
  ...
  calendarPlot(possible_and_actual_sap_days, pollutant= "sap_gals", breaks= c(0, 10, 20, 30, 40, 50, 60, 80, 100), year= name_arg, cols= "Blues", main= "Actual Days Collected")
}
```
...
lapply(list_of_years, Plot_months)
```
